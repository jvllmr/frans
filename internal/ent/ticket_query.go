...
func (_q *TicketQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *File)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(ticket.FilesTable)
		s.Join(joinT).On(s.C(file.FieldID), joinT.C(ticket.FilesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(ticket.FilesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(ticket.FilesPrimaryKey[0]))
