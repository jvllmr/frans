...
func (m *FileMutation) SetDataID(id string) {
	m.data = &id
}
...
// DataCleared reports if the "data" edge to the FileData entity was cleared.
func (m *FileMutation) DataCleared() bool {
	return m.cleareddata
}

// DataID returns the "data" edge ID in the mutation.
func (m *FileMutation) DataID() (id string, exists bool) {
	if m.data != nil {
		return *m.data, true
	}
	return
...
func (m *FileMutation) DataIDs() (ids []string) {
	if id := m.data; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *FileMutation) AddedEdges() []string {
	...
	if m.data != nil {
		edges = append(edges, file.EdgeData)
	}
	return edges
}
...
func withFileDataID(id string) filedataOption {
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of FileData entities.
func (m *FileDataMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *FileDataMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *FileDataMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
...
func (m *FileDataMutation) SetSize(u uint64) {
	m.size = &u
	m.addsize = nil
}

// Size returns the value of the "size" field in the mutation.
func (m *FileDataMutation) Size() (r uint64, exists bool) {
	v := m.size
	if v == nil {
		return
	}
...
// OldSize returns the old "size" field's value of the FileData entity.
// If the FileData object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileDataMutation) OldSize(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileDataMutation) AddSize(u int64) {
	if m.addsize != nil {
		*m.addsize += u
	} else {
		m.addsize = &u
...
func (m *FileDataMutation) AddedSize() (r int64, exists bool) {
	v := m.addsize
	if v == nil {
		return
	}
...
func (m *FileDataMutation) ResetSize() {
	m.size = nil
	m.addsize = nil
}

// AddUserIDs adds the "users" edge to the User entity by ids.
func (m *FileDataMutation) AddUserIDs(ids ...uuid.UUID) {
	if m.users == nil {
...
func (m *FileDataMutation) ClearUsers() {
	m.clearedusers = true
}

// UsersCleared reports if the "users" edge to the User entity was cleared.
func (m *FileDataMutation) UsersCleared() bool {
	return m.clearedusers
}

// RemoveUserIDs removes the "users" edge to the User entity by IDs.
func (m *FileDataMutation) RemoveUserIDs(ids ...uuid.UUID) {
...
func (m *FileDataMutation) RemovedUsersIDs() (ids []uuid.UUID) {
...
func (m *FileDataMutation) UsersIDs() (ids []uuid.UUID) {
...
func (m *FileDataMutation) ResetUsers() {
	m.users = nil
...
func (m *FileDataMutation) AddFileIDs(ids ...uuid.UUID) {
	if m.files == nil {
...
func (m *FileDataMutation) ClearFiles() {
	m.clearedfiles = true
}

// FilesCleared reports if the "files" edge to the File entity was cleared.
func (m *FileDataMutation) FilesCleared() bool {
	return m.clearedfiles
}

// RemoveFileIDs removes the "files" edge to the File entity by IDs.
func (m *FileDataMutation) RemoveFileIDs(ids ...uuid.UUID) {
...
func (m *FileDataMutation) RemovedFilesIDs() (ids []uuid.UUID) {
...
func (m *FileDataMutation) FilesIDs() (ids []uuid.UUID) {
...
func (m *FileDataMutation) ResetFiles() {
	m.files = nil
...
func (m *FileDataMutation) Fields() []string {
	...
	if m.size != nil {
		fields = append(fields, filedata.FieldSize)
	}
	return fields
}
...
func (m *FileDataMutation) AddedEdges() []string {
	...
	if m.users != nil {
		edges = append(edges, filedata.EdgeUsers)
	}
	if m.files != nil {
		edges = append(edges, filedata.EdgeFiles)
	}
	return edges
}
...
func (m *FileDataMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case filedata.EdgeUsers:
		ids := make([]ent.Value, 0, len(m.users))
		for id := range m.users {
			ids = append(ids, id)
		}
		return ids
	case filedata.EdgeFiles:
...
type UserMutation struct {
	...
	removedgrants        map[uuid.UUID]struct{}
	clearedgrants        bool
	fileinfos            map[string]struct{}
	removedfileinfos     map[string]struct{}
	clearedfileinfos     bool
	done                 bool
...
func (m *UserMutation) AddFileinfoIDs(ids ...string) {
	if m.fileinfos == nil {
		m.fileinfos = make(map[string]struct{})
	}
	for i := range ids {
		m.fileinfos[ids[i]] = struct{}{}
	}
}

// ClearFileinfos clears the "fileinfos" edge to the FileData entity.
func (m *UserMutation) ClearFileinfos() {
	m.clearedfileinfos = true
}

// FileinfosCleared reports if the "fileinfos" edge to the FileData entity was cleared.
func (m *UserMutation) FileinfosCleared() bool {
	return m.clearedfileinfos
}

// RemoveFileinfoIDs removes the "fileinfos" edge to the FileData entity by IDs.
func (m *UserMutation) RemoveFileinfoIDs(ids ...string) {
	if m.removedfileinfos == nil {
		m.removedfileinfos = make(map[string]struct{})
	}
	for i := range ids {
		delete(m.fileinfos, ids[i])
		m.removedfileinfos[ids[i]] = struct{}{}
	}
}

// RemovedFileinfos returns the removed IDs of the "fileinfos" edge to the FileData entity.
func (m *UserMutation) RemovedFileinfosIDs() (ids []string) {
	for id := range m.removedfileinfos {
		ids = append(ids, id)
	}
	return
}

// FileinfosIDs returns the "fileinfos" edge IDs in the mutation.
func (m *UserMutation) FileinfosIDs() (ids []string) {
	for id := range m.fileinfos {
		ids = append(ids, id)
	}
	return
}

// ResetFileinfos resets all changes to the "fileinfos" edge.
func (m *UserMutation) ResetFileinfos() {
	m.fileinfos = nil
	m.clearedfileinfos = false
	m.removedfileinfos = nil
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.fileinfos != nil {
		edges = append(edges, user.EdgeFileinfos)
	}
	return edges
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeGrants:
		...
		return ids
	case user.EdgeFileinfos:
		ids := make([]ent.Value, 0, len(m.fileinfos))
		for id := range m.fileinfos {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []ent.Value {
	...
	case user.EdgeGrants:
		...
		return ids
	case user.EdgeFileinfos:
		ids := make([]ent.Value, 0, len(m.removedfileinfos))
		for id := range m.removedfileinfos {
			ids = append(ids, id)
		}
		return ids
