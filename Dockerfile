FROM docker.io/golang:1.26.6-alpine@sha256:3889b425f035be855a72fb4755265311293b6d414521f0a519d819df32222d83 AS server-base

FROM docker.io/node:24.19.0-alpine@sha256:d32cdf619f63fe0471182d08996dd516c6275bb5fd31ae06e55a570bd9e1ad43 AS client-base
WORKDIR /workspace
ENV PNPM_HOME="/pnpm"
