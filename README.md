...
| `color`                   | string     | Color variant. One of [Mantine colors](https://mantine.dev/theming/colors/#default-colors) in lower case or `custom`                          | `blue`                 | `FRANS_COLOR`                   |
| `custom_color`            | [10]string | Custom color palette consisting of 10 color hex values. Can be generated via [Mantine color generator](https://mantine.dev/colors-generator/) | _only black_           | `FRANS_CUSTOM_COLOR`            |
